...
def run():
    with sync_playwright() as p:
        ...
        # Check if center is Decimal
        is_center_decimal = page.evaluate("window.fractalApp.state.center.x instanceof Decimal")
        print(f"Center is Decimal: {is_center_decimal}")

        # Take screenshot
        page.screenshot(path="verification/screenshot_fixed_v2.png")
        browser.close()
